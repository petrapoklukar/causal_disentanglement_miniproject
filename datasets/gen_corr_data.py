...
for i in range(grid):
    grid_h=[]
    for j in range(grid):
        grid_h.append(X_list[i*grid+j][0])
...
print("generated: " + str(len(X_list)) + " images.")
...
for i in range(grid):
    grid_h=[]
    for j in range(grid):
        grid_h.append(Y_list[i*grid+j][0])
...
print("pkl save: " + str(save_pkl))
print("generated: " + str(len(Y_list)) + " images.")
