...
for config in "VAE_NonCausalDsprite_ber_shape2_scale5_ld2" \
        ...
        "VAE_NonCausalDsprite_ber_shape2_scale5_ld6" \
        "VAE_NonCausalDsprite_ber_shape2_scale5_ld10" \
        "VAE_CausalDsprite_ber_shape2_scale5_ld2" \
        "VAE_CausalDsprite_ber_shape2_scale5_ld3" \
        "VAE_CausalDsprite_ber_shape2_scale5_ld4" \
        "VAE_CausalDsprite_ber_shape2_scale5_ld6" \
        "VAE_CausalDsprite_ber_shape2_scale5_ld10"; do
